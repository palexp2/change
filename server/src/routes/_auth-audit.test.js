...
const PUBLIC_ROUTES = new Map([
  ...
  ['GET /api/connectors/amazon/callback',            'OAuth callback — browser redirect from Amazon (LWA), validated via code exchange'],
  ['GET /api/hooks/:token',                          'Webhook entrant public — le token dans l\'URL est le secret (voir routes/hooks.js)'],
  ...
  ['GET /api/customer/post-payment/by-token/:token',         'Customer onboarding via short token (token-based auth, validated via loadByToken)'],
  ['POST /api/customer/post-payment/by-token/:token/save',   'Customer onboarding autosave via short token (token-based auth)'],
  ['POST /api/customer/post-payment/by-token/:token/submit', 'Customer onboarding submit via short token (token-based auth)'],
  ['POST /api/customer/post-payment/by-token/:token/valve-blocks-checkout', 'Valve blocks Stripe Checkout via short token (token-based auth)'],
...
const MOUNTS = {
  ...
  'treasury.js':                '/api/treasury',
  'travaux.js':                 '/api/travaux',
  'bank.js':                    '/api/bank',
  ...
  'telnyx-webhooks.js':         '/api/hooks/telnyx',
  'ticket-surveys-public.js':   '/api/public/ticket-survey',
  'auth.js':                    '/api/auth',
